...
//    }
    ...
    void rightTest2(){
        Game game = new Game();
        game.init();
        game.setElem(0,0,16);game.setElem(0,1,8);game.setElem(0,2,2);game.setElem(0,3,2);
        game.setElem(1,0,2);game.setElem(1,1,0);game.setElem(1,2,0);game.setElem(1,3,0);
        game.setElem(2,0,4);game.setElem(2,1,0);game.setElem(2,2,0);game.setElem(2,3,0);
        game.setElem(3,0,2);game.setElem(3,1,0);game.setElem(3,2,0);game.setElem(3,3,2);
    ...
    void upTest2(){
        Game game = new Game();
        game.init();
        game.setElem(0,0,4);game.setElem(0,1,0);game.setElem(0,2,0);game.setElem(0,3,0);
        game.setElem(1,0,2);game.setElem(1,1,0);game.setElem(1,2,4);game.setElem(1,3,0);
        game.setElem(2,0,0);game.setElem(2,1,0);game.setElem(2,2,0);game.setElem(2,3,0);
        game.setElem(3,0,2);game.setElem(3,1,0);game.setElem(3,2,0);game.setElem(3,3,0);
    ...
    void downTest1(){
        Game game = new Game();
        game.init();
        game.setElem(0,0,2);game.setElem(0,1,16);game.setElem(0,2,8);game.setElem(0,3,2);
        game.setElem(1,0,2);game.setElem(1,1,2);game.setElem(1,2,4);game.setElem(1,3,2);
        game.setElem(2,0,0);game.setElem(2,1,0);game.setElem(2,2,8);game.setElem(2,3,2);
        game.setElem(3,0,0);game.setElem(3,1,0);game.setElem(3,2,0);game.setElem(3,3,0);
